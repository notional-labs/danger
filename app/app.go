...
var (
	_ runtime.AppI            = (*DangerApp)(nil)
	_ servertypes.Application = (*DangerApp)(nil)
)
...
func (app *DangerApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey *storetypes.KVStoreKey) {
...
func (app *DangerApp) setPostHandler() {
...
func (app *DangerApp) Name() string { return app.BaseApp.Name() }
